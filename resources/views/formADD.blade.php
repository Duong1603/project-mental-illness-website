    ...
    <!-- enctype='multipart/form-data' -->
        ...
        <!-- @method('put') -->
            <div class="row">
                ...
                <input type="text" class="col form-control" name="title" value="{{isset($post) ? $post->title: ""}}">
            </div>
            ...
            <div class="row mt-3">
                ...
                <input type="text" class="col form-control" name="content" value="{{isset($post) ? $post->content : ""}}">
            </div>
